...
export const abilities = {
  // --- Cogforge: Ironwright ---
  overclock: {
    id: 'overclock', name: 'Overclock', targeting: 'unit', cooldown: 14, cost: { energy: 25 },
  ...
  turretDrop: {
    id: 'turretDrop', name: 'Turret Drop', targeting: 'point', cooldown: 22, cost: { energy: 45 },
  ...
  forgeRepair: {
    id: 'forgeRepair', name: 'Forge Repair', targeting: 'unit', cooldown: 10, cost: { energy: 20 },
  ...
  rendingPounce: {
    id: 'rendingPounce', name: 'Rending Pounce', targeting: 'point', cooldown: 12, cost: { energy: 30 },
  ...
  primalHowl: {
    id: 'primalHowl', name: 'Primal Howl', targeting: 'unit', cooldown: 14, cost: { energy: 25 },
    effect: 'buffAttackSpeed', params: { duration: 8, magnitudePerLevel: 0.12 }, maxLevel: 3,
    description: 'Rallies a unit into a faster-striking frenzy.',
  },
  mendFlesh: {
    id: 'mendFlesh', name: 'Mend Flesh', targeting: 'unit', cooldown: 10, cost: { energy: 20 },
  ...
  // --- Vharn: Genestitcher ---
  causticSpray: {
    id: 'causticSpray', name: 'Caustic Spray', targeting: 'point', cooldown: 12, cost: { energy: 30 },
  ...
  neuralLock: {
    id: 'neuralLock', name: 'Neural Lock', targeting: 'unit', cooldown: 16, cost: { energy: 35 },
    effect: 'stun', params: { durationPerLevel: 1.2 }, maxLevel: 3,
    description: 'Overloads an enemy’s nervous system, freezing it in place.',
  },
  chitinFrenzy: {
    id: 'chitinFrenzy', name: 'Chitin Frenzy', targeting: 'unit', cooldown: 14, cost: { energy: 25 },
    effect: 'buffAttackSpeed', params: { duration: 8, magnitudePerLevel: 0.12 }, maxLevel: 3,
